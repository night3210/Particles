...
public class SpeeddModuleAndRangeInitializer implements com.example.mirash.particles.particles.initializers.ParticleInitializer {
    ...
    public void initParticle(Particle p, Random r) {
        ...
        p.setSpeedY0((float) (speed * Math.sin(angleInRads)));
    }
