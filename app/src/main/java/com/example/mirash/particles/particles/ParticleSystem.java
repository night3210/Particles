...
import com.example.mirash.particles.particles.initializers.AccelerationInitializer;
import com.example.mirash.particles.particles.initializers.ParticleInitializer;
import com.example.mirash.particles.particles.initializers.RotationInitiazer;
import com.example.mirash.particles.particles.initializers.RotationSpeedInitializer;
import com.example.mirash.particles.particles.initializers.RotationZInitiazer;
import com.example.mirash.particles.particles.initializers.ScaleInitializer;
import com.example.mirash.particles.particles.initializers.SpeeddByComponentsInitializer;
import com.example.mirash.particles.particles.initializers.SpeeddModuleAndRangeInitializer;
...
public class ParticleSystem {
    ...
    private com.example.mirash.particles.particles.ParticleField mDrawingView;

    private ArrayList<com.example.mirash.particles.particles.Particle> mParticles;
    private final ArrayList<com.example.mirash.particles.particles.Particle> mActiveParticles = new ArrayList<com.example.mirash.particles.particles.Particle>();
    ...
    private ParticleSystem(Activity a, int maxParticles, long timeToLive, int parentResId) {
        ...
        mParticles = new ArrayList<com.example.mirash.particles.particles.Particle>();
...
//		}
    ...
    public ParticleSystem(Activity a, int maxParticles, Drawable bitmapDrawables[], long timeToLive, int parentViewId) {
        this(a, maxParticles, timeToLive, parentViewId);
        Random r = new Random();
        for (int i = 0; i < mMaxParticles; i++) {
            int index = r.nextInt(bitmapDrawables.length);
            mParticles.add(new Particle(((BitmapDrawable) bitmapDrawables[index]).getBitmap()));
        }
    }

    public ParticleSystem(Activity a, int maxParticles, int bitmapDrawableIds[], long timeToLive, int parentViewId) {
        this(a, maxParticles, timeToLive, parentViewId);
        Drawable[] drawables = new Drawable[bitmapDrawableIds.length];
        for (int i = 0; i < bitmapDrawableIds.length; i++) {
            drawables[i] = a.getResources().getDrawable(bitmapDrawableIds[i]);
        }
        Random r = new Random();
        for (int i = 0; i < mMaxParticles; i++) {
            int index = r.nextInt(drawables.length);
            mParticles.add(new Particle(((BitmapDrawable) drawables[index]).getBitmap()));
        }
    }
    ...
    public ParticleSystem(Activity a, int maxParticles, Bitmap bitmaps[], long timeToLive, int parentViewId) {
        ...
        Random r = new Random();
        for (int i = 0; i < mMaxParticles; i++) {
            int index = r.nextInt(bitmaps.length);
            mParticles.add(new Particle(bitmaps[index]));
        }
    }
    ...
    public ParticleSystem setRotationSpeedZ(float min, float max) {
        mInitializers.add(new RotationZInitiazer(min, max));
        return this;
    }
    ...
    private void startEmiting(int particlesPerSecond) {
        ...
        mDrawingView = new com.example.mirash.particles.particles.ParticleField(mParentView.getContext());
